...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements service.ServiceService {
    ...
    public service.Service getService() throws javax.xml.rpc.ServiceException {
    ...
    public service.Service getService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            service.ServiceSoapBindingStub _stub = new service.ServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (service.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                service.ServiceSoapBindingStub _stub = new service.ServiceSoapBindingStub(new java.net.URL(Service_address), this);
                _stub.setPortName(getServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service", "ServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service", "Service"));
        }
